...
# NOTE: right-prompt + transient-prompt disabled below (manual edit, not
# regenerated by oh-my-posh) — they caused every keystroke to append a new
# line in WezTerm, likely from a terminal-width/cursor-position mismatch.
...
$env.POSH_CONFIG = 'C:\Users\%USERPROFILE%\AppData\Roaming\nushell\catppuccin_frappe.omp.json'
$env.POSH_SHELL = "nu"
